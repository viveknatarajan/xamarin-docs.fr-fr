...
description: Ce document fournit une vue d’ensemble de watchOS, qui décrit le cycle de vie des applications, les types d’interface utilisateur, tailles d’écran, limitations et bien plus encore.
ms.prod: xamarin
