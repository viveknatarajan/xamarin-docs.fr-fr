...
description: 'Ce document décrit backgrounding dans iOS : États de l’application, méthodes de cycle de vie des applications et l’actualisation d’application en arrière-plan.'
ms.prod: xamarin
