...
description: Ce document décrit les différents moyens de stockage des données dans une application Xamarin.iOS et fournit des informations spécifiques sur les avantages de SQLite.
ms.prod: xamarin
