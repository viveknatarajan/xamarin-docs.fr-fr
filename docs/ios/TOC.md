...
### [Installation et configuration](get-started/installation/index.md)
...
#### [Configurer un appareil pour le développement](get-started/installation/device-provisioning/index.md)
...
#### [Partie 1 : Démarrage rapide](get-started/hello-ios/hello-ios-quickstart.md)
#### [Partie 2 : Immersion](get-started/hello-ios/hello-ios-deepdive.md)
### [Hello, iOS Multiscreen](get-started/hello-ios-multiscreen/index.md)
#### [Partie 1 : Démarrage rapide](get-started/hello-ios-multiscreen/hello-ios-multiscreen-quickstart.md)
#### [Partie 2 : Immersion](get-started/hello-ios-multiscreen/hello-ios-multiscreen-deepdive.md)
...
#### [Sélecteur](user-interface/controls/picker.md)
...
#### [Vues web](user-interface/controls/uiwebview.md)
...
#### [Raccourcis Siri](platform/introduction-to-ios12/siri-shortcuts.md)
...
#### [Changements web dans iOS 11](platform/introduction-to-ios11/web.md)
...
#### [Autres changements apportés au framework iOS 10](platform/introduction-to-ios10/additional-framework-changes.md)
### [Introduction à iOS 9](platform/introduction-to-ios9/index.md)
#### [Compatibilité iOS 9](platform/introduction-to-ios9/ios9.md)
#### [Autres changements apportés au framework iOS 9](platform/introduction-to-ios9/additional-framework-changes.md)
...
#### [Changements apportés à StoreKit](platform/introduction-to-ios6/changes-to-storekit.md)
...
### [Compression de fichier](platform/file-compression.md)
...
#### [Procédure pas à pas : graphisme et animation](platform/graphics-animation-ios/graphics-animation-walkthrough.md)
...
### [Intégration de l’application Messages](platform/message-app-integration/index.md)
#### [Bases d’une extension de l’application Messages](platform/message-app-integration/intro-to-message-app-extensions.md)
#### [Extensions avancées de l’application Messages](platform/message-app-integration/advanced-message-app-extensions.md)
### [Multitâche pour iPad](platform/multitasking.md)
### [PassKit](platform/passkit.md)
### [PhotoKit](platform/photokit.md)
### [Demander une révision d’application](platform/request-app-review.md)
...
#### [Notifications utilisateur améliorées](platform/user-notifications/enhanced-user-notifications.md)
#### [Notifications utilisateur avancées](platform/user-notifications/advanced-user-notifications.md)
#### [Technologies de notification dépréciées](platform/user-notifications/deprecated/index.md)
...
### [Couleur à spectre large](platform/wide-color.md)
...
### [Informations de l'application](~/essentials/app-information.md?context=xamarin/ios)
...
### [Convertisseurs de couleurs](~/essentials/color-converters.md?context=xamarin/ios)
### [Boussole](~/essentials/compass.md?context=xamarin/ios)
### [Connectivité](~/essentials/connectivity.md?context=xamarin/ios)
### [Détecter les secousses](~/essentials/detect-shake.md?context=xamarin/ios)
...
### [Messagerie](~/essentials/email.md?context=xamarin/ios)
...
### [Extensions de plateforme (taille, rectangle, point)](~/essentials/platform-extensions.md?context=xamarin/ios)
...
### [Partager](~/essentials/share.md?context=xamarin/ios)
### [SMS](~/essentials/sms.md?context=xamarin/ios)
### [Synthèse vocale](~/essentials/text-to-speech.md?context=xamarin/ios)
### [Convertisseurs d’unités](~/essentials/unit-converters.md?context=xamarin/ios)
...
##### [Étape 1. Registre](~/cross-platform/data-cloud/active-directory/get-started/register.md?context=xamarin/ios)
##### [Étape 2. Configurer](~/cross-platform/data-cloud/active-directory/get-started/configure.md?context=xamarin/ios)
#### [Accès à l’API Graph](~/cross-platform/data-cloud/active-directory/graph.md?context=xamarin/ios)
...
## [Déploiement et tests](deploy-test/index.md)
### [Distribution d’applications](deploy-test/app-distribution/index.md)
#### [Distribution dans l’App Store](deploy-test/app-distribution/app-store-distribution/index.md)
##### [Configurer votre application dans iTunes Connect](deploy-test/app-distribution/app-store-distribution/itunesconnect.md)
##### [Publication sur l’App Store](deploy-test/app-distribution/app-store-distribution/publishing-to-the-app-store.md)
...
#### [Prise en charge de fichier IPA](deploy-test/app-distribution/ipa-support.md)
...
#### [Informations de référence sur la clé/valeur Info.plist](deploy-test/provisioning/infoplist-reference.md)
...
### [Test unitaire](deploy-test/touch.unit.md)
...
#### [Informations de référence sur les types de liaison](~/cross-platform/macios/binding/binding-types-reference.md?context=xamarin/ios)
...
###### [Liaison de frameworks natifs](~/cross-platform/macios/binding/objective-sharpie/platform/native-frameworks.md?context=xamarin/ios)
...
### [Questions fréquemment posées](troubleshooting/questions/index.md)
...
#### [Où définir l’emplacement de mon kit SDK iOS ?](troubleshooting/questions/ios-sdk.md)
...
#### [Où trouver le fichier .dSYM pour générer les symboles des journaux de plantage iOS ?](troubleshooting/questions/symbolicate-ios-crash.md)
...
#### [Changer le chemin de sortie du fichier IPA](troubleshooting/questions/ipa-output-path.md)
...
#### [Pourquoi ma soumission d’application échoue avec : « Chemins non autorisés (« iTunesMetadata.plist ») trouvés sur... » ?](troubleshooting/questions/itunesmetadata-disallowed-paths.md)
#### [Erreur de concepteur iOS avec RegisterServicePort](troubleshooting/questions/error-registerserviceport.md)
#### [Pourquoi ma build iOS échoue avec le message disant qu’aucun code iPhone valide pour signer les clés n’a été trouvé dans le trousseau ?](troubleshooting/questions/no-codesigning-keys.md)
#### [Pourquoi mon application iOS 9 échoue avec : System.Exception : Impossible de marshaler l’objet Objective-C ?](troubleshooting/questions/exception-marshal-obj-c.md)
...
#### [MDocArchiveToMsxDocConverter.exe introuvable rver.BaseCommand.OnRequest](troubleshooting/questions/mdocarchivetomsxdocconverter-not-found.md)
...
#### [Références de projets](watchos/get-started/project-references.md)
### [Notions de base des applications](watchos/app-fundamentals/index.md)
#### [Application parente](watchos/app-fundamentals/parent-app.md)
#### [App Groups](watchos/app-fundamentals/app-groups.md)
#### [Icônes](watchos/app-fundamentals/icons.md)
#### [Mise en page](watchos/app-fundamentals/layout.md)
...
#### [Paramètres](watchos/app-fundamentals/settings.md)
...
##### [Autres changements apportés au framework watchOS 3](watchos/platform/introduction-to-watchos3/additional-framework-changes.md)
...
#### [Tâches d’arrière-plan](watchos/platform/background-tasks.md)
...
#### [Améliorations apportées à l’application Exercice](watchos/platform/workout-apps.md)
...
##### [Autres changements apportés au framework iOS 10](tvos/platform/introduction-to-tvos10/additional-framework-changes.md)
...
#### [Vues divisées](tvos/user-interface/split-views.md)
...
### [Déploiement et tests](tvos/deploy-test/index.md)
#### [Distribution d’applications](tvos/deploy-test/app-distribution/index.md)
...
## [Notes de publication](https://docs.microsoft.com/xamarin/ios/release-notes/)
