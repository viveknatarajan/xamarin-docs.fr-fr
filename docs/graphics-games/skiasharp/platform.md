...
description: "Détails sur l’utilisation de SkiaSharp dans votre plateforme. brève : fournissent des détails sur la façon d’afficher votre contenu SkSurface dans votre application d’origine."
ms.topic: article
ms.prod: xamarin
