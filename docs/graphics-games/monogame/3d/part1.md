...
![Le modèle de rendu simplement sa texture, mais avec aucun ombrage ou spéculaire de Halo](part1-images/image9.png "le modèle de rendu simplement sa texture, mais avec aucun ombrage ou spéculaire de Halo")
