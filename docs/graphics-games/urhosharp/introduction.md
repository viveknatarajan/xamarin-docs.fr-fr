...
description: Ce document décrit la structure de base d’une application de UrhoSharp et de des liens vers les différents guides et des exemples d’applications qui montrent comment utiliser UrhoSharp.
ms.prod: xamarin
