...
description: Ce document liens vers des guides pas à pas qui décrivent comment ajouter Urho à un projet natif existant pour une plateforme spécifique. Elle explique Android, iOS, tvOS, macOS, Windows et Xamarin.Forms.
ms.prod: xamarin
