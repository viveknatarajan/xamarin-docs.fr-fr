...
En commençant par Xamarin Studio 5.7.2.7 (et version ultérieure, Visual Studio pour Mac) et Visual Studio Tools pour Xamarin 3.9.344, ces paramètres peuvent être personnalisés par projet.
