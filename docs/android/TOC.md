...
#### [Implémentation avec des fragments](platform/fragments/implementing-with-fragments/index.md)
##### [Procédure pas à pas](platform/fragments/implementing-with-fragments/walkthrough.md)
##### [Prise en charge préversion Honeycomb](platform/fragments/implementing-with-fragments/supporting-pre-honeycomb.md)
...
### [Services connectés Azure](~/cross-platform/data-cloud/connected-services.md?context=xamarin/android)
