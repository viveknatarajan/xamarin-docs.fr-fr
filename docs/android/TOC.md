...
#### [Préversion de Microsoft OpenJDK](get-started/installation/openjdk.md)
...
### [Capteur d’orientation](~/essentials/open-browser.md?context=xamarin/android)
### [Numéroteur téléphonique](~/essentials/phone-dialer.md?context=xamarin/android)
### [Puissance](~/essentials/power.md?context=xamarin/android)
