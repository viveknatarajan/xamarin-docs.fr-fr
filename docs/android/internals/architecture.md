...
-   *Remarque :* Informations d’emplacement assembly comme [Assembly.Location](xref:System.Reflection.Assembly.Location) et [Assembly.CodeBase](xref:System.Reflection.Assembly.CodeBase)
    *ne peut pas se reposer* dans les versions Release. Ils n’existent pas sous forme d’entrées de système de fichiers distinct, et ils n’ont à aucun emplacement utilisable.
...
3.  Le *monodroid.apidemo.LogTextBox* constructeur s’exécute le [android.widget.TextView](https://developer.android.com/reference/android/widget/TextView.html#TextView%28android.content.Context,%20android.util.AttributeSet%29) constructeur.
