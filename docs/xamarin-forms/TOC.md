...
##### [Bitmaps SkiaSharp](user-interface/graphics/skiasharp/bitmaps/index.md)
###### [Affichage de bitmaps](user-interface/graphics/skiasharp/bitmaps/displaying.md)
###### [Création et dessin sur des bitmaps](user-interface/graphics/skiasharp/bitmaps/drawing.md)
###### [Rognage de bitmaps](user-interface/graphics/skiasharp/bitmaps/cropping.md)
###### [Affichage segmenté de bitmaps](user-interface/graphics/skiasharp/bitmaps/segmented.md)
###### [Enregistrement de bitmaps dans des fichiers](user-interface/graphics/skiasharp/bitmaps/saving.md)
###### [Accès aux bits de pixel de bitmap](user-interface/graphics/skiasharp/bitmaps/pixel-bits.md)
###### [Animation de bitmaps](user-interface/graphics/skiasharp/bitmaps/animating.md)
...
### [Prise en main](~/essentials/get-started.md?context=xamarin/xamarin-forms)
...
### [Transfert de données](~/essentials/data-transfer.md?context=xamarin/xamarin-forms)
...
### [Puissance](~/essentials/power.md?context=xamarin/xamarin-forms)
### [Préférences](~/essentials/preferences.md?context=xamarin/xamarin-forms)
### [Verrouillage d’écran](~/essentials/screen-lock.md?context=xamarin/xamarin-forms)
