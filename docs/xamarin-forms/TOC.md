...
### [Indexation d’applications et liens ciblés](app-fundamentals/deep-linking.md)
### [comportements](app-fundamentals/behaviors/index.md)
#### [Introduction](app-fundamentals/behaviors/introduction.md)
#### [Comportements attachés](app-fundamentals/behaviors/attached.md)
#### [Comportements Xamarin.Forms](app-fundamentals/behaviors/creating.md)
...
#### [Classes de base de renderer et contrôles natifs](app-fundamentals/custom-renderer/renderers.md)
#### [Personnalisation d’une entrée](app-fundamentals/custom-renderer/entry.md)
#### [Personnalisation d’un ContentPage](app-fundamentals/custom-renderer/contentpage.md)
...
#### [Implémentation d’une vue](app-fundamentals/custom-renderer/view.md)
...
### [Effects (Effets)](app-fundamentals/effects/index.md)
...
### [Mouvements](app-fundamentals/gestures/index.md)
...
#### [Affichages](user-interface/controls/views.md)
...
#### [Grille](user-interface/layouts/grid.md)
...
#### [Compression des dispositions](user-interface/layouts/layout-compression.md)
### [Affichage de liste](user-interface/listview/index.md)
...
### [Curseur](user-interface/slider.md)
...
### [Texte](user-interface/text/index.md)
#### [Etiquette](user-interface/text/label.md)
...
#### [Thème de lumière](user-interface/themes/light.md)
...
### [Informations de l'application](~/essentials/app-information.md?context=xamarin/xamarin-forms)
...
### [Messagerie](~/essentials/email.md?context=xamarin/xamarin-forms)
...
#### [Intégration d’Azure Active Directory B2C à Azure Mobile Apps](data-cloud/authentication/azure-ad-b2c-mobile-app.md)
...
#### [Reconnaissance des émotions](data-cloud/cognitive-services/emotion-recognition.md)
...
### [Renderers rapides](internals/fast-renderers.md)
