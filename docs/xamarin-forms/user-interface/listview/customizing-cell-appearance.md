---
title: Personnaliser l’apparence de la cellule de ListView
description: Cet article explore les options de présentation des données dans les applications de Xamarin.Forms, tout en tirant parti de la commodité du contrôle ListView.
ms.prod: xamarin
...
ms.locfileid: "35244754"
---
# <a name="customizing-listview-cell-appearance"></a>Personnaliser l’apparence de la cellule de ListView
