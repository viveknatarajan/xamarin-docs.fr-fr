...
ListView est une vue pour la présentation des listes de données, en particulier longues listes qui requièrent un défilement. Ce guide vous explique comment utiliser ListView :
