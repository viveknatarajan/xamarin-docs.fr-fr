...
description: Cet article explique comment utiliser SkiaSharp pour dessiner des courbes et utiliser les fonctionnalités de chemin d’accès dans les applications de Xamarin.Forms et cela est illustré par l’exemple de code.
ms.prod: xamarin
