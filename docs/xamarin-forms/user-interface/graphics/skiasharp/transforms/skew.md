...
description: Cet article explique comment la transformation d’inclinaison peut créer des objets graphiques inclinées dans SkiaSharp et cela est illustré par l’exemple de code.
ms.prod: xamarin
