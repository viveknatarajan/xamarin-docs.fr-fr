...
description: Thhis article explore la transformation d’échelle SkiaSharp mise à l’échelle des objets de différentes tailles et cela est illustré par l’exemple de code.
ms.prod: xamarin
