...
description: Cet article examine les différents effets possibles avec les types de remplissage SkiaSharp chemin d’accès et cela est illustré par l’exemple de code.
ms.prod: xamarin
