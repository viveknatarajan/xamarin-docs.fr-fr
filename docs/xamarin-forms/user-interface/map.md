...
```
 ...
 `PinType` peut être définie à une des valeurs suivantes, qui peuvent affecter la façon dont le code confidentiel de rendu (en fonction de la plateforme) :
