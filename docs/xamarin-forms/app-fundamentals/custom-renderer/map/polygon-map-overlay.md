...
description: Cet article explique comment ajouter un segment de recouvrement de polygone à une carte, pour mettre en surbrillance une région sur la carte. Les polygones sont une forme fermée et leurs intérieurs renseigner.
ms.prod: xamarin
