...
Pour plus d’informations sur l’utilisation d’une base de données SQLite, consultez [Xamarin.Forms de bases de données locales](~/xamarin-forms/app-fundamentals/databases.md).
