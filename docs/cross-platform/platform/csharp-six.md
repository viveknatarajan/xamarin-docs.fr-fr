...
* **Visual Studio 2015 et 2017** et versions ultérieures prennent en charge complète c# 6. Versions antérieures de Visual Studio (par exemple). 2013, 2012) ne prendra pas en charge c# 6.
