...
|[Applications oranges pour entreprise](http://www.orange-business.com/en/contact-us)|Paris, France ; Zurich, Suisse|Orange Business Services est un opérateur d’internationale de télécommunications et de la société de services informatiques. Leurs 20 000 employés prend en charge les sociétés, les institutions publiques locales et les organismes du secteur public dans tous les aspects de leur transformation numérique. Ils aider les entreprises à collaborer plus efficacement, fonctionner plus efficacement et collaborer mieux avec leurs clients ' Äì connectant les personnes, sites et des ordinateurs de manière sécurisée et fiable.|
...
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Royaume-Uni|Screenmedia est convaincu que pour créer des solutions humaines, centrées pour les clients et les utilisateurs finaux, ils doivent être une entreprise axée humaine. Leur vision et les valeurs entièrement reflètent celle et bien entendu, comme le font leurs employés. Culture de pratique de Screenmedia est la clé à leur réussite. Il « Äôs ce que les lecteurs et victime leurs innovations dans les technologies émergentes ; vous aide à crée des partenariats agiles avec les clients ; et il ' Äôs, ce qui rend très difficile fonctionne plus agréable.|
|[Séquence](https://www.sequence.co.uk/)|Cardiff, Royaume-Uni ; Londres, Royaume-Uni|Séquence est une agence numérique creative établie en 1995. Spécialisé dans la conception, stratégie et l’expérience utilisateur, ils ont travaillé avec certaines des plus grandes entreprises du Royaume-Uni en secteurs allant de la fabrication de voyage et du tourisme. Marques qui se connectent avec leurs clients via la passion et l’innovation.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Tyne d’upon Newcastle, Royaume-Uni|Depuis son lancement en 2011, Shinobicontrols a été création complètes et puissantes des contrôles de l’interface utilisateur interactives pour développeurs iOS et Android. En 2012, elles lancées shinobicharts, leur premier produit. Depuis lors, ils ' Äôve évolué rapidement et maintenant qu’ils fournissent des solutions de l’interface utilisateur à des milliers de clients avec notre portefeuille rapidement des produits.|
