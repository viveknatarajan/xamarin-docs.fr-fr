...
description: Ce document décrit comment démarrer avec le SDK de classeurs de Xamarin, ce qui peut être utilisé pour développer des intégrations pour les classeurs Xamarin.
ms.prod: xamarin
